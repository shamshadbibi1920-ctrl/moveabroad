...
import { GraduationCap, DollarSign, Calendar, FileText, Clock, AlertTriangle, CheckCircle2, TrendingUp, Info, ArrowLeft, Globe } from 'lucide-react';
...
export default function GermanyScholarships() {
  ...
  return (
    <>
      <SEO title="Study in Germany: Scholarships | MoveAbroad.pk" description="Comprehensive guide to germany scholarships for Pakistani students and professionals moving abroad." />
