...
export default function AustraliaDocuments() {
  return (
    <>
      <SEO title="Migrate to Australia Documents | MoveAbroad.pk" description="Comprehensive guide to australia documents for Pakistani students and professionals moving abroad." />
