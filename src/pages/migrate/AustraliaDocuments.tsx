...
import { ShieldCheck, ChevronRight, CheckCircle2, FileCheck2, AlertTriangle, Building2, Globe2 } from 'lucide-react';
    ...
    <div className="bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors duration-300 pb-20">
      <div className="bg-slate-900 py-16 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">A comprehensive guide to gathering documents from Pakistan for Australian Skilled Visas.</p>
        </div>
      </div>
