...
import { ShieldCheck, ChevronRight, CheckCircle2, CalendarClock, Briefcase, Plane, Landmark } from 'lucide-react';
  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors duration-300 pb-20">
      <div className="relative text-white py-20 lg:py-32 overflow-hidden bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        <img src="https://images.unsplash.com/photo-1599394020836-b4870c9f4e6c?auto=format&fit=crop&q=80" onError={(e) => { e.currentTarget.style.display = 'none'; e.currentTarget.parentElement!.style.background = 'linear-gradient(135deg, #1e3a8a, #1e293b)'; }}
          loading="eager"
          className="absolute inset-0 w-full h-full object-cover" alt="Malta" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold text-white mb-4">Malta Permanent Residence (MPRP) 🇲🇹</h1>
          <p className="text-xl text-slate-300 max-w-3xl">A straightforward, investment-based path to permanent residency in an English-speaking EU nation.</p>
        </div>
      </div>
