...
import { ShieldCheck, ChevronRight, CheckCircle2, Heart, Users, Calculator, AlertCircle, FileText, CalendarClock, ArrowLeft, Globe } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <motion.div initial="initial" animate="animate" variants={{ initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5 } }} className="max-w-3xl">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Sponsor your spouse, partner, or dependent children to become permanent residents of Canada.
            </p>
          </motion.div>
        </div>
      </div>
