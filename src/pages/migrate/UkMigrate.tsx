...
import { ShieldCheck, ChevronRight, CheckCircle2, Briefcase, FileCheck2, Globe2, AlertTriangle, Cross, Activity, Users, Award, Star } from 'lucide-react';
    ...
    <div className="bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors duration-300 pb-20">
      ...
      <div className="bg-slate-900 py-16 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold text-white mb-4">Migrate to the United Kingdom</h1>
          <p className="text-xl text-slate-300 max-w-3xl">Comprehensive guide to Global Talent, Skilled Worker, and Health & Care Visas.</p>
        </div>
      </div>
