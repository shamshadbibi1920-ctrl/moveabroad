...
export default function SaudiGoldenVisa() {
  return (
    <>
      <SEO 
        title="Saudi Golden Visa | MoveAbroad.pk" 
        description="Comprehensive guide to saudi golden visa for Pakistani students and professionals moving abroad." 
        ogImage="/images/blog/saudi-golden-visa.jpg"
        ogType="article"
      />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="mb-10 rounded-2xl overflow-hidden aspect-[16/9] sm:aspect-[21/9] w-full bg-slate-100 dark:bg-slate-700 shadow-sm relative">
            <img
              src="/images/blog/saudi-golden-visa.jpg"
              alt="Futuristic architectural skyline of King Abdullah Financial District in Riyadh"
