...
export default function SwedishInstituteScholarship() {
  return (
    <>
      <SEO 
        title="Swedish Institute Scholarship | MoveAbroad.pk" 
        description="Comprehensive guide to swedish institute scholarship for Pakistani students and professionals moving abroad." 
        ogImage="/images/blog/swedish-institute-scholarship.jpg"
        ogType="article"
      />
        ...
        >
          ...
          <div className="flex flex-wrap items-center text-slate-500 dark:text-slate-400 text-sm mb-10 pb-8 border-b border-slate-100 dark:border-slate-700 gap-4">
            ...
            <div className="flex items-center">
              ...
              <span>Last updated: Sep 01, 2026</span>
            </div>
          </div>
