...
export default function DhaLicensingExam() {
  return (
    <>
      <SEO 
        title="Dha Licensing Exam | MoveAbroad.pk" 
        description="Comprehensive guide to dha licensing exam for Pakistani students and professionals moving abroad." 
        ogImage="/images/blog/dha-licensing-dubai.jpg"
        ogType="article"
      />
        ...
        >
          ...
          <div className="flex flex-wrap items-center text-slate-500 dark:text-slate-400 text-sm mb-10 pb-8 border-b border-slate-100 dark:border-slate-700 gap-4">
            <div className="flex items-center">
              ...
              <span>Written by Dr. M. Malik, MBBS (Founder & Lead Editor)</span>
            </div>
            <div className="flex items-center">
          ...
          <div className="mb-10 rounded-2xl overflow-hidden aspect-[16/9] sm:aspect-[21/9] w-full bg-slate-100 dark:bg-slate-700 shadow-sm relative">
            <img
              src="/images/blog/dha-licensing-dubai.jpg"
              alt="Modern healthcare hospital and medical center in Dubai"
