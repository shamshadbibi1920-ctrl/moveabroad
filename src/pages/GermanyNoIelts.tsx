...
import { Globe, AlertTriangle, CheckCircle2, ArrowLeft } from 'lucide-react';
...
export default function GermanyNoIelts() {
  ...
  return (
    <>
      <SEO title="Study in Germany: No Ielts | MoveAbroad.pk" description="Comprehensive guide to germany no ielts for Pakistani students and professionals moving abroad." />
