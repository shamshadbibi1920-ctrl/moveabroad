...
export default function AustraliaDoctorIndex() {
  return (
    <>
      <SEO title="Australia Doctor Index | MoveAbroad.pk" description="Comprehensive guide to australia doctor index for Pakistani students and professionals moving abroad." />
