...
export default function AustraliaDoctorCompetent() {
  return (
    <>
      <SEO title="Australia Doctor Competent | MoveAbroad.pk" description="Comprehensive guide to australia doctor competent for Pakistani students and professionals moving abroad." />
