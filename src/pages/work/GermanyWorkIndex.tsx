...
export default function GermanyWorkIndex() {
  ...
  return (
    <>
      <SEO title="Germany Work Index | MoveAbroad.pk" description="Comprehensive guide to germany work index for Pakistani students and professionals moving abroad." />
