...
import { ArrowLeft, Languages, ExternalLink, GraduationCap, CheckCircle2 } from 'lucide-react';
      ...
      <div className="bg-rose-900 py-16 border-b border-rose-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }} className="text-xl text-rose-100 max-w-3xl font-light">
            Canada is primarily English-speaking, but French is a powerful asset. Know what exams you need to take.
          </motion.p>
        </div>
      </div>
