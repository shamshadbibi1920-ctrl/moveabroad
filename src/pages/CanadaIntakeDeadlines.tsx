...
import { Calendar, AlertTriangle, ArrowRight, Clock, Target } from 'lucide-react';
      ...
      <div className="relative text-white py-20 lg:py-32 overflow-hidden bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial="initial" animate="animate" variants={staggerContainer} className="max-w-3xl">
            <Link to="/study/canada" className="inline-flex items-center text-rose-300 hover:text-white mb-6 transition-colors">
            ...
            <motion.p variants={fadeIn} className="text-xl text-rose-50 mb-8 leading-relaxed">
